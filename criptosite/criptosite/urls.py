...
from views.views_home import home, shift_view, multiplicative_view, DES_view, DESimage_view,AESimage_view,TDESimage_view, downloadimg_file, downloadimge_file, sustitutive_view, vigenere_view, hill_view, substitution_view, shiftcryptoanalisis_view, vigenerecryptoanalisis_view, affine_view, affinecryptoanalisis_view, substitutioncryptoanalisis_view, gammaPentagonal_view, download_file
