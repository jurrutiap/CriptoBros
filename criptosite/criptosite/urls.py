...
from views.views_home import home, shift_view, multiplicative_view, sustitutive_view, vigenere_view, hill_view, substitution_view, shiftcryptoanalisis_view, vigenerecryptoanalisis_view, affine_view, affinecryptoanalisis_view, download_file
